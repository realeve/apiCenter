...
define('zrender/zrender', [
    ...
    Title.prototype = {
		...
		//增加版权备注说明文字
		var copyrightfont = this.getFont(this.titleOption.copyright.textStyle);
		var copyright = this.titleOption.copyright.text;	
		var copyrighttextShape = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {                    
					y: this.zr.getHeight()-zrArea.getTextHeight(copyright, copyrightfont) - 10,
					x: this.zr.getWidth()-zrArea.getTextWidth(copyright, copyrightfont) - 10,
                    color: this.titleOption.copyright.textStyle.color,
                    text: copyright,
                    textFont: copyrightfont,
                    textBaseline: 'top'
                },
                highlightStyle: {
                    color: zrColor.lift(this.titleOption.copyright.textStyle.color, 1),
                    brushType: 'fill'
                },
                hoverable: false
            };			
            this.shapeList.push(new TextShape(copyrighttextShape));
        },
        _buildBackground: function () {
        ...
        _getItemGroupLocation: function () {
            ...
            var text = this.titleOption.text;
            var subtext = this.titleOption.subtext;
			var copyrighttext = this.titleOption.copyrighttext;
            var font = this.getFont(this.titleOption.textStyle);
            var subfont = this.getFont(this.titleOption.subtextStyle);
