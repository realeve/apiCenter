  ...
  <div class="page-container page-container-responsive">
    <div class="row row-space-top-8 row-space-8 row-table">
        <div class="col-6 col-middle">
          ...
          <h2 class="yahei morespace">对不起，我们没能在服务器中找到您所请求的页面.</h2>
          <ul class="list-unstyled">
            <li class="yahei">下面这些页面可能对您有用 :</li>
            <li><a href="../../welcome">首页</a></li>
            <li><a href="../../search">信息查询</a></li>
            <li><a href="../../welcome/logout">登录</a></li>
          </ul>
        </div>
    ...
    <div class="col-md-6 col-md-offset-3" style="color: #a2abb7;">
      <div class="page-footer-inner">
         <p class="text-center">2015 &copy; 成都印钞有限公司 . 技术质量部 .</p>
      </div>
    </div>
