            ...
            <div class="tab-content">
               ...
               <div class="tab-pane  active page-quick-sidebar-settings" id="quick_sidebar_tab_4">
                  <div class="page-quick-sidebar-settings-list">
                     ...
                     <h3 class="list-heading">表格设置</h3>                     
                     <ul class="list-items borderless">
                        <li class="tooltips" data-container="body" data-placement="left" data-html="true" data-original-title="表格过长时固定表头，需刷新页面重载设置">
                            固定表头<input id="FixTblHead" type="checkbox" class="make-switch" checked data-on-color="success" data-on-text="是" data-off-color="danger" data-off-text="否">
                        </li>       
                        <li class="tooltips" data-container="body" data-placement="left" data-html="true" data-original-title="列数过多时固定首列，需刷新页面重载设置">
                            固定首列<input id="FixTblCol" type="checkbox" class="make-switch" checked data-on-color="success" data-on-text="是" data-off-color="danger" data-off-text="否">
                        </li>    
                        <li class="tooltips" data-container="body" data-placement="left" data-html="true" data-original-title="为每列添加单独过滤功能，需刷新页面重载设置">
                            底部搜索<input id="FootSearch" type="checkbox" class="make-switch" checked data-on-color="success" data-on-text="是" data-off-color="danger" data-off-text="否">
                        </li>              
                     </ul>
                     <h3 class="list-heading hide hide">表单设置</h3>                     
                     <ul class="list-items borderless hide">
                        <li class="tooltips" data-container="body" data-placement="left" data-html="true" data-original-title="数据录入完毕后自动切换到下一个输入框">
                            输入切换<input id="InputToggle" type="checkbox" class="make-switch" checked data-on-color="success" data-on-text="是" data-off-color="danger" data-off-text="否">
                        </li>       
                        <li class="tooltips" data-container="body" data-placement="left" data-html="true" data-original-title="勾选后在原单元格内输入或浮动区域输入，需刷新页面重载设置">
                            单元格内输入<input id="InputInner" type="checkbox" class="make-switch" checked data-on-color="success" data-on-text="是" data-off-color="danger" data-off-text="否">
                        </li>             
                     </ul>
                     <div class="containt row">
                        <div class="inner-content col-md-4 pull-right" style="margin:10px 40px 0 0px">
                           <button id="SaveSettings" class="btn btn-success btn-circle"><i class="icon-settings"></i>保存设置</button>
                        </div>
                     </div>
                  </div>
               </div>
