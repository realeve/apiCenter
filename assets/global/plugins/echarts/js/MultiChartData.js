...
var optionMap = {
	multiCharts : (function (){
        functionMap.multiCharts = function (){
			...
			$('#mcMain2').removeClass('main2').addClass('main noLoading');
			$('#mcMain3').removeClass('main2').addClass('main noLoading');
			
            myChart2 = echarts.init(document.getElementById('mcMain2'),curTheme);
            myChart2.setOption(option2);
			            
            myChart3 = echarts.init(document.getElementById('mcMain3'),curTheme);
